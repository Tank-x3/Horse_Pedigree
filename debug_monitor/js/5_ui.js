...
window.App.UI = {
    ...
    handleCellClick: function(horseId) {
        // App.Utils.Logger.add('UI', `Cell Click: ${horseId}`); // ログ量過多ならコメントアウト
    ...
    handleSaveImage: async function() {
        ...
        try {
            ...
            App.Utils.Logger.add('UI', 'Image saved', { fileName });
        } catch (e) { 
            App.Utils.Logger.add('UI', 'Image save failed', { error: e.message });
            console.error(e); 
            alert('保存失敗'); 
